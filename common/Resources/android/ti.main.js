...
var functionCall = NATIVE_BIND$3 ? call$6.bind(call$6) : function () {
...
objectGetOwnPropertyDescriptor.f = DESCRIPTORS$a ? $getOwnPropertyDescriptor$1 : function getOwnPropertyDescriptor(O, P) {
  ...
  if (hasOwn$9(O, P)) return createPropertyDescriptor$2(!call$2(propertyIsEnumerableModule.f, O, P), O[P]);
};
...
var functionApply = typeof Reflect == 'object' && Reflect.apply || (NATIVE_BIND$1 ? call$1.bind(apply$2) : function () {
...
var exportGlobalErrorCauseWrapper = function (ERROR_NAME, wrapper) {
  ...
  $$7({ global: true, constructor: true, arity: 1, forced: FORCED$4 }, O);
};
...
var exportWebAssemblyErrorCauseWrapper = function (ERROR_NAME, wrapper) {
  if (WebAssembly && WebAssembly[ERROR_NAME]) {
    ...
    $$7({ target: WEB_ASSEMBLY, stat: true, constructor: true, arity: 1, forced: FORCED$4 }, O);
  }
};
...
// https://github.com/tc39/proposal-error-cause
$$6({ global: true, constructor: true, arity: 2, forced: FORCED$3 }, {
...
var FORCED$1 = DESCRIPTORS$1 && fails$3(function () {
...
if (!NATIVE_ARRAY_BUFFER_VIEWS || !TypedArrayPrototype$2 || TypedArrayPrototype$2 === ObjectPrototype) {
  TypedArrayPrototype$2 = TypedArray.prototype;
  if (NATIVE_ARRAY_BUFFER_VIEWS) for (NAME in TypedArrayConstructorsList) {
    if (global$2[NAME]) setPrototypeOf(global$2[NAME].prototype, TypedArrayPrototype$2);
  }
}

// WebKit bug - one more object in Uint8ClampedArray prototype chain
if (NATIVE_ARRAY_BUFFER_VIEWS && getPrototypeOf(Uint8ClampedArrayPrototype) !== TypedArrayPrototype$2) {
  setPrototypeOf(Uint8ClampedArrayPrototype, TypedArrayPrototype$2);
}

if (DESCRIPTORS && !hasOwn(TypedArrayPrototype$2, TO_STRING_TAG)) {
