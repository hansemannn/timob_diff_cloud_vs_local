...
private:
	...
	static void isPaused(const v8::FunctionCallbackInfo<v8::Value>&);
	static void isPlaying(const v8::FunctionCallbackInfo<v8::Value>&);
	static void stop(const v8::FunctionCallbackInfo<v8::Value>&);
	static void setLooping(const v8::FunctionCallbackInfo<v8::Value>&);
	static void release(const v8::FunctionCallbackInfo<v8::Value>&);
	static void isLooping(const v8::FunctionCallbackInfo<v8::Value>&);
	...
	static void getter_looping(v8::Local<v8::Name> name, const v8::PropertyCallbackInfo<v8::Value>& info);
	static void setter_looping(v8::Local<v8::Name> name, v8::Local<v8::Value> value, const v8::PropertyCallbackInfo<void>& info);
