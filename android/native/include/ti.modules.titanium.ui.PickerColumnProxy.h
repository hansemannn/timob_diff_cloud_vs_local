...
private:
	...
	static void removeRow(const v8::FunctionCallbackInfo<v8::Value>&);
	static void addRow(const v8::FunctionCallbackInfo<v8::Value>&);
	...
	static void setter_rows(v8::Local<v8::Name> name, v8::Local<v8::Value> value, const v8::PropertyCallbackInfo<void>& info);
	static void setter_font(v8::Local<v8::Name> name, v8::Local<v8::Value> value, const v8::PropertyCallbackInfo<void>& info);
